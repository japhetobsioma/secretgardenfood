...
/**
 * Print Premium Customer Reservation Class
 *
 * @author Japhet Mert Catilo Obsioma
 * @version 3.00, 10/28/2020
 */
public class PrintPremCusReservation {
    ...
    public static void print() throws IOException {
        ...
        try {
            ...
            PdfWriter writer = PdfWriter.getInstance(document,
                    new FileOutputStream("receipts/PremCusReservation/"
            ...
            tblItems.addCell("1");
            tblItems.addCell(String.valueOf(PremCusReservation.getNewReceipt().getReceiptTotalCost()));
            ...
            document.close();
            writer.close();
            Desktop.getDesktop().open(new File("receipts/PremCusReservation/"
                    + java.time.LocalDate.now() + "-"
                    + PremCusReservation.getNewReceipt().getReceiptNo() + ".pdf"));
